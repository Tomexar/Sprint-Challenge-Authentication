...
1. What does bcrypt do to slow down attackers?
    ...
    The passwords are hashed making them very difficult and almost impossible to get, if a hacker were to obtain the has it would provide the user with plenty of time to change their passwords 
